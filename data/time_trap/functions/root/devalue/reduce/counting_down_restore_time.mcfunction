execute if score @s tt_reduceCopper matches 1.. run scoreboard players remove @s tt_reduceCopper 1
...
execute if score @s tt_reduceCopper matches 0 run function time_trap:root/devalue/reduce/reduce_copper_level
